...
export interface Note { id: string; title: string; content?: string | null; pinned: boolean; archived: boolean; favorite: boolean; color?: string | null; folderId?: string | null; projectId?: string | null; tags?: Tag[]; createdAt: string; updatedAt: string; }
export interface NoteFolder { id: string; name: string; parentId?: string | null; notes?: { id: string }[]; }
export interface Project { id: string; name: string; description?: string | null; color?: string | null; status: ProjectStatus; startDate?: string | null; dueDate?: string | null; progress?: number; deletedAt?: string | null; _count?: Record<string, number>; }
export interface Habit { id: string; name: string; color?: string | null; icon?: string | null; scheduleDayBits: number; current?: number; longest?: number; }
