              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td style="width:36px;height:36px;font-family:${FONT};">
                    <img src="${escapeHtml((process.env.PUBLIC_URL ?? "https://agenda.glutensafe.es").replace(/\/$/, ""))}/brand/icon-192.png" width="36" height="36" alt="Dayly" style="display:block;width:36px;height:36px;border:0;border-radius:10px;" />
                  </td>
